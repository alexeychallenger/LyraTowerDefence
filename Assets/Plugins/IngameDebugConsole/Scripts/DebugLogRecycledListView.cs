...
namespace IngameDebugConsole
{
	public class DebugLogRecycledListView : MonoBehaviour
	{
		// Cached components
		[SerializeField]
		private RectTransform transformComponent = default;
        [SerializeField]
		private RectTransform viewportTransform = default;

        [SerializeField]
		private DebugLogManager debugManager = default;

        [SerializeField]
		private Color logItemNormalColor1 = default;
        [SerializeField]
		private Color logItemNormalColor2 = default;
        [SerializeField]
		private Color logItemSelectedColor = default;
