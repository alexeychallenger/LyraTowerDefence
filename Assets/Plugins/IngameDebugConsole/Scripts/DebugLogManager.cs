...
namespace IngameDebugConsole
{
	...
	public class DebugLogManager : MonoBehaviour
	{
		...
		[Header( "Visuals" )]
		[SerializeField]
		private DebugLogItem logItemPrefab = default;

        // Visuals for different log types
        [SerializeField]
		private Sprite infoLog = default;
        [SerializeField]
		private Sprite warningLog = default;
        [SerializeField]
		private Sprite errorLog = default;

        private Dictionary<LogType, Sprite> logSpriteRepresentations;

		[SerializeField]
		private Color collapseButtonNormalColor = default;
        [SerializeField]
		private Color collapseButtonSelectedColor = default;

        [SerializeField]
		private Color filterButtonsNormalColor = default;
        [SerializeField]
		private Color filterButtonsSelectedColor = default;

        [Header( "Internal References" )]
		[SerializeField]
		private RectTransform logWindowTR = default;

        private RectTransform canvasTR;

		[SerializeField]
		private RectTransform logItemsContainer = default;

        [SerializeField]
		private InputField commandInputField = default;

        [SerializeField]
		private Image collapseButton = default;

        [SerializeField]
		private Image filterInfoButton = default;
        [SerializeField]
		private Image filterWarningButton = default;
        [SerializeField]
		private Image filterErrorButton = default;

        [SerializeField]
		private Text infoEntryCountText = default;
        [SerializeField]
		private Text warningEntryCountText = default;
        [SerializeField]
		private Text errorEntryCountText = default;

        [SerializeField]
		private GameObject snapToBottomButton = default;
		...
		[SerializeField]
		private CanvasGroup logWindowCanvasGroup = default;

        private bool isLogWindowVisible = true;
		private bool screenDimensionsChanged = false;

		[SerializeField]
		private DebugLogPopup popupManager = default;

        [SerializeField]
		private ScrollRect logItemsScrollRect = default;

        // Recycled list view to handle the log items efficiently
        [SerializeField]
		private DebugLogRecycledListView recycledListView = default;
