...
namespace IngameDebugConsole
{
	public class DebugLogPopup : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		[SerializeField]
		private DebugLogManager debugManager = default;

        [SerializeField]
		private Text newInfoCountText = default;
        [SerializeField]
		private Text newWarningCountText = default;
        [SerializeField]
		private Text newErrorCountText = default;
		...
		[SerializeField]
		private Color alertColorInfo = default;
        [SerializeField]
		private Color alertColorWarning = default;
        [SerializeField]
		private Color alertColorError = default;
